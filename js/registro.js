...
function validateEmail(data) {
    var result;
    $.ajax({
        url: "http://140.238.191.252:8080/api/user/emailexist/" + data.email,
        type: "GET",
        contentType: "application/JSON",
        success: function(response) {
            if (response) {
...
function validateAuth(data) {
    $.ajax({
        url: "http://140.238.191.252:8080/api/user/" + data.email + "/" + data.password,
        type: "GET",
        contentType: "application/JSON",
        success: function(response) {
...
function signout(data) {
    ...
    $.ajax({
        url: "http://140.238.191.252:8080/api/user/new",
        type: "POST",
        dataType: "json",
        contentType: "application/JSON",
